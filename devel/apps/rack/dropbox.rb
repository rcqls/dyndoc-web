...
class DropBox < Renee::Application
	...
	app {
		path  '/oauth-start' do
			get {
			    ...
			    auth_url = db_session.get_authorize_url request.base_url'/dropbox/oauth-callback'
			    redirect! auth_url 
			}	
		end

		path '/oauth-callback' do
			get {
			    # Finish OAuth Step 2
